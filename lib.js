function AmountOut(amountIn, reserveIn, reserveOut) {
    let amountInWithFee = amountIn * 0.995;
...
function checkRateChange(reserveIn, reserveOut, amount, exactIn = true) {
    
    let rate0 = reserveIn / reserveOut

    if (exactIn) {
        let amountOut = AmountOut(amount, reserveIn, reserveOut)
        reserveIn += amount
...
function amountCheck(resvETH, resvToken, targetValue, amountOut, exactIn = true) {
...
function profitCheck(resvETH, resvToken, targetIn, targetOut, frontValue, exactIn = true) {
...
export { checkRateChange, amountCheck, profitCheck, AmountOut, parseToken }